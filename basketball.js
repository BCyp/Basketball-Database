...
var setSecondTeamName = function(ray){
	var found = false;
	var secondName;
	var i = 1;
	while (found === false){
		if( ray[i].team !== teamOne){
...
var createTeamArray = function(name){  
	var newTeam = playArray.filter(function(player){
